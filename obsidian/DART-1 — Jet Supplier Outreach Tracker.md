...
- [ ] **Rotorsan (RTJ-900 PRO)** — ✅ **Mutual NDA FULLY EXECUTED via DocuSign 07-27** (all signers completed 16:10; Bülent signed directly). **7/31 8am PDT call stood down** — Bülent never confirmed + my travel conflicts. Pivoted to **written data request**: reply **drafted 07-29** sending the full RTJ-900 PRO question set (product def, installed mass/envelope/CG, SLS + design-point performance, redline limits, fuel/electrical/control interfaces, inlet/exhaust/thermal, duty/restart/TBO + altitude test evidence, commercial) so data flows async, **plus** a request for their next availability for a live call. Send it. **Front-runner.**
...
| **Rotorsan** | RTJ-900 / RTJ-900 PRO | Türkiye | Bülent Akyürek (info@rotorsan.com) | 2026-07-28 | **Theirs** | ✅ **Mutual NDA FULLY EXECUTED via DocuSign 07-27** (all signers completed 16:10; Bülent signed directly, no reassignment). 7/31 call stood down (unconfirmed + my travel); **written RTJ-900 PRO question set drafted 07-29** to run data async, plus request for next call availability. **Front-runner** |
