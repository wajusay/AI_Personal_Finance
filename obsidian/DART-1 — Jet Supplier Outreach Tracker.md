...
- [ ] **Rotorsan (RTJ-900 PRO)** — ✅ **Mutual NDA FULLY EXECUTED via DocuSign 07-27**. **Sent 07-29**: confirmed executed NDA + requested the detailed RTJ-900 PRO package (performance, installed mass/dims, electrical/control interfaces, limits) + proposed 7/31 8am PDT call. **7/31 now off on my side (flight); Bülent never confirmed.** Short follow-up **sent 07-29** standing down 7/31, requesting their next availability. **Reminder follow-up drafted 07-31** (in Drafts) — references the executed NDA, ready to begin evaluation, condensed re-list of the info still requested (product def / mass+envelope+CG / SLS + design-point performance / limits / interfaces / duty+life / commercial) + reiterates call offer. **Ball with Rotorsan** (RTJ-900 PRO data + a proposed time). **Front-runner.**
...
| **Rotorsan** | RTJ-900 / RTJ-900 PRO | Türkiye | Bülent Akyürek (info@rotorsan.com) | 2026-07-28 | **Theirs** | ✅ **Mutual NDA FULLY EXECUTED via DocuSign 07-27**. Sent 07-29: confirmed NDA + requested detailed RTJ-900 PRO package + proposed 7/31 call. 7/31 now off (my flight); short follow-up sent 07-29 to stand down 7/31 & request next availability (data ask already out). **Front-runner** |
